        ...
        <div class="span16">
            <div class="box">
				...
				<table border=0>
					...
					<tr>
						<td>NIP </td> 
						<td><input type="number" name="nip" value="<?php echo $this->input->post('nip'); ?>" /></td>
					</tr>
					<tr>
						<td>NIDN </td> 
				...
				<table border=0>
					...
					<tr>
						<td>Golongan TMT</td> 
						<td><input class="datepicker" type="text" name="gol_tmt" value="<?php echo $this->input->post('gol_tmt'); ?>" /></td>
					</tr>
					<tr>
						<td>Jabatan</td> 
					...
					<tr>
						<td>Jabatan TMT</td> 
						<td><input type="number" name="jabatan_tmt" value="<?php echo $this->input->post('jabatan_tmt'); ?>" /></td>
					</tr>
					<tr>
