                    ...
                    <div id="Person-3" class="box">
                        ...
                        <div class="box-hide-me box-content collapse in">
                                ...
                                <tr>
                                    ...
                                    <td><a target="_BLANK" style="color:#047a2c; text-decoration: none;" href="<?php echo $r_peraturan['url']; ?>" class="btn btn-small btn-default"><i class="btn-icon-only icon-download"> Unduh</i></a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                            </table>
