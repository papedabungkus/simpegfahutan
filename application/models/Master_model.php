...
class Master_model extends CI_Model
{
    ...
    function jsondosen() {
        ...
        $this->datatables->add_column('action',anchor(site_url('master/reset/$1'),'<i class="btn-icon-only icon-key"> </i>',array('onclick'=>'javasciprt: return confirm(\'Anda yakin akan mereset password ?\')','class'=>'btn btn-small btn-default','title'=>'Reset Password Login'))." ".anchor(site_url('master/update/$1'),'<i class="btn-icon-only icon-pencil"> </i>',array('class'=>'btn btn-small btn-info','title'=>'Edit Data Dosen'))." ".anchor(site_url('master/delete/$1'),'<i class="btn-icon-only icon-remove"> </i>',array('onclick'=>'javasciprt: return confirm(\'Are You Sure ?\')','class'=>'btn btn-small btn-danger','title'=>'Hapus Data Dosen')), 'id');
    ...
    function jsonpegawai() {
        ...
        $this->datatables->add_column('action',anchor(site_url('master/reset/$1'),'<i class="btn-icon-only icon-key"> </i>',array('onclick'=>'javasciprt: return confirm(\'Anda yakin akan mereset password ?\')','class'=>'btn btn-small btn-default','title'=>'Reset Password Login'))." ".anchor(site_url('master/update/$1'),'<i class="btn-icon-only icon-pencil"> </i>',array('class'=>'btn btn-small btn-info','title'=>'Edit Data Pegawai'))." ".anchor(site_url('master/delete/$1'),'<i class="btn-icon-only icon-remove"> </i>',array('onclick'=>'javasciprt: return confirm(\'Are You Sure ?\')','class'=>'btn btn-small btn-danger','title'=>'Hapus Data Pegawai')), 'id');
        return $this->datatables->generate();
    }
